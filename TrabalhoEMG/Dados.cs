...
namespace TrabalhoEMG
{
    public class Dados
    {
        ...
        public static string CLIENTS_PESO = "Peso Do Cliente";
        public static string CLIENTS_PRATICADESPORTO = "Prática de Desporto";
        ...
        public Dados()
        {
            ...
            TableClients.Columns.Add(CLIENTS_PESO);
            TableClients.Columns.Add(CLIENTS_PRATICADESPORTO);
